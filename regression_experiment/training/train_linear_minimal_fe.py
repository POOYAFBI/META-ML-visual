...
# Print results
print("\n" + "=" * 70)
print("LINEAR REGRESSION RESULTS - MINIMAL FE")
print("=" * 70)
...
# Full FE results (from previous training)
full_fe_train_rmse = None  # Not available
full_fe_train_r2 = None    # Not available
full_fe_test_rmse = 22974.15
full_fe_test_r2 = 0.8994
...
if rmse_impact_pct > 5:
    ...
    print(f"   • Linear Regression heavily depends on engineered features")
    print(f"   • RMSE increased by {rmse_impact_pct:.2f}%")
    print(f"   • Linear models cannot automatically create feature interactions")
    ...
    print(f"   • Linear Regression is robust without engineered features")
    ...
    print(f"   • Engineered features may have introduced noise")
...
report_lines = []
report_lines.append("# Linear Regression Training Summary - Minimal FE")
report_lines.append("")
...
report_lines.append("")
if rmse_impact_pct > 5:
    report_lines.append("**Finding:** Linear Regression shows SIGNIFICANT DEPENDENCE on engineered features.")
    report_lines.append("")
    ...
    report_lines.append("- Linear models cannot automatically create feature interactions")
    report_lines.append("- Engineered features like TotalSF, OverallScore provided explicit patterns")
    report_lines.append("- Without these, the model's predictive power declined noticeably")
elif rmse_impact_pct > 1:
    report_lines.append("**Finding:** Linear Regression shows MODERATE DEPENDENCE on engineered features.")
    report_lines.append("")
    report_lines.append("**Evidence:**")
    report_lines.append(f"- Test RMSE increased by {rmse_impact_pct:.2f}%")
    report_lines.append(f"- Test R² decreased by {abs(r2_impact_pct):.2f}%")
else:
    report_lines.append("**Finding:** Linear Regression is ROBUST without engineered features.")
    report_lines.append("")
    report_lines.append("**Evidence:**")
...
# Save report
with open('LINEAR_MINIMAL_FE_SUMMARY.md', 'w', encoding='utf-8') as f:
    f.write('\n'.join(report_lines))

print("\n✓ Saved: LINEAR_MINIMAL_FE_SUMMARY.md")
